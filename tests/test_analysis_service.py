...
async def test_analyze_property_success(mock_response):
    with patch('requests.get', return_value=mock_response), \
         patch('backend.services.analysis_service.save_pre_analysis') as mock_save:
...
def test_extract_basic_data(mock_response):
    from backend.services.analysis_service import extract_basic_data
    url = "https://exemplo.com/imovel"
...
def test_extract_value_minimo():
    from backend.services.analysis_service import extract_value_minimo
...
def test_extract_data_leilao():
    from backend.services.analysis_service import extract_data_leilao
